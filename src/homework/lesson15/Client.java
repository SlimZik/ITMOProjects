...
import com.itmo.iostreams.serial.print.PrintClient;
...
public class Client {
    ...
    public Client(SocketAddress serverAddr, Scanner scanner) {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Client client = new Client(parseAddress(addr), scanner);
